...
export function ProfileAvatar() {
  return (
    <div className="group relative">
      ...
      <span className="pointer-events-none invisible absolute -top-9 right-0 whitespace-nowrap rounded-[var(--radius-sm)] border border-[var(--color-border)] bg-[rgba(255,255,255,0.9)] px-2 py-1 text-[10px] uppercase tracking-[0.08em] text-[var(--color-text-muted)] opacity-0 backdrop-blur-[8px] transition-opacity duration-200 group-hover:visible group-hover:opacity-100 group-focus-within:visible group-focus-within:opacity-100">
        Say hello →
      </span>
    </div>
  );
